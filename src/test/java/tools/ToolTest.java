...
public class ToolTest {
    ...
    public void insert_ToolWithoutName_IllegalArgumentException(){
        ...
        assertThrows(IllegalArgumentException.class, () -> createToolUseCase.insert(tool));
    }
    ...
    public void insert_ToolWithCorrectArguments_ToolClass(){
        ...
        assertEquals(Tool.class, createToolUseCase.insert(tool).getClass());
    }
    ...
    public void insert_InsertToolAlreadyExists_EntityAlreadyExistsException() {
        ...
        assertThrows(EntityAlreadyExistsException.class, () -> createToolUseCase.insert(tool));
    }

    @Test
    public void findByUUID_ToolWithoutUUID_IllegalArgumentException() {
        Tool tool = new Tool(null);
        assertThrows(IllegalArgumentException.class, () -> findToolUseCase.findByUUID(tool.getId()));
    }
    ...
    public void findAllTools_Normal_ArrayOfTools() {
        assertEquals(ArrayList.class, findToolUseCase.findAll().getClass());
    }

    @Test
    public void remove_ToolWithoutUUID_EntityNotFoundException() {
        Tool tool = new Tool(null);
        assertThrows(EntityNotFoundException.class, () -> removeToolUseCase.remove(tool.getId()));
    }
    ...
    public void remove_RemoveToolWithCorrectArguments_ToolClass() {
        ...
        createToolUseCase.insert(tool);
        assertEquals(Tool.class, removeToolUseCase.remove(tool.getId()).getClass());
    }

    @Test
    public void update_OnlyWithUUID_IllegalArgumentException() {
        Tool tool = new Tool(UUID.randomUUID());
        assertThrows(IllegalArgumentException.class, () -> updateToolUseCase.update(tool));
    }
    ...
    public void update_UpdateWithCorrectArgs_ToolClass() {
        ...
        assertEquals(Tool.class, updateToolUseCase.update(tool).getClass());
    }
